...
> = {
  ...
  better: {
    name: "Better",
    description: "Enhanced quality with improved features",
    features: [
  ...
  best: {
    name: "Best",
    description: "Premium materials with maximum protection",
    features: [
    ...
    <div>
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-2">
          Choose your material quality
        </h2>
        <p className="text-muted-foreground">
          Select the quality tier that fits your needs and budget.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {(["good", "better", "best"] as MaterialTier[]).map((tier, index) => {
          ...
          return (
            <button
              key={tier}
              onClick={() => updateData({ materialTier: tier })}
